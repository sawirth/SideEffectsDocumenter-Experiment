...
public class TestsFootball extends TestCase{
    public void test01() {
        ...
        Club barcelona = new Club("Barcelona", new President("Josep Maria Bartomeu"),"Nike");
        Club realMadrid = new Club("Real Madrid", new President("Real Madrid President"),"Adidas");
